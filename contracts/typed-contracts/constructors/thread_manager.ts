...
import { ContractFile } from '../contract-info/thread_manager';
...
export default class Constructors {
	...
	* new
	*
	* @param { ArgumentTypes.Hash } threadHash,
	*/
   	async "new" (
		threadHash: ArgumentTypes.Hash,
		...
		const storageDepositLimit = __options?.storageDepositLimit;
			const tx = code.tx["new"]!({ gasLimit, storageDepositLimit, value: __options?.value }, threadHash);
			let response;
