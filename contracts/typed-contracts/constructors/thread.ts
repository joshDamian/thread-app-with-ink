...
import { ContractFile } from '../contract-info/thread';
...
export default class Constructors {
	...
	* @param { ArgumentTypes.AccountId | null } parent,
	*/
   	async "new" (
		message: string,
		creator: ArgumentTypes.AccountId,
		threadHash: ArgumentTypes.Hash,
		parent: ArgumentTypes.AccountId | null,
		...
		const storageDepositLimit = __options?.storageDepositLimit;
			const tx = code.tx["new"]!({ gasLimit, storageDepositLimit, value: __options?.value }, message, creator, threadHash, parent);
			let response;
